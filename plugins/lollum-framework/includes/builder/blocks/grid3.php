...
function lolfmk_print_grid3_admin($item = null) {
	...
	$id7 = (lolfmk_find_xml_value($item, 'id7')) ? lolfmk_find_xml_value($item, 'id7') : '';
	$id8 = (lolfmk_find_xml_value($item, 'id8')) ? lolfmk_find_xml_value($item, 'id8') : '';
	...
	echo '<div class="page-item item-grid-3 item-1-1" data-type="item-grid-3" data-item="Grid-3">';

	lolfmk_item_btns(__('Grid-3', 'lollum'), 'yes');
	lolfmk_item_before_inner(__('Grid-3', 'lollum'));
	...
	$ob_id7 = array(
		'name' => __('Item ID 7', 'lollum'),
		'data' => 'id7',
		'value' => $id7,
		'desc' => __('The ID of the item', 'lollum')
	);

	lolfmk_pb_text($ob_id7);
	...
	$ob_id8 = array(
		'name' => __('Item ID 8', 'lollum'),
		'data' => 'id8',
		'value' => $id8,
		'desc' => __('The ID of the item', 'lollum')
	);

	lolfmk_pb_text($ob_id8);
