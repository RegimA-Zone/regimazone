...
function lolfmk_print_grid1_admin($item = null) {
	...
	echo '<div class="page-item item-grid-1 item-1-1" data-type="item-grid-1" data-item="Grid-1">';

	lolfmk_item_btns(__('Grid-1', 'lollum'), 'yes');
	lolfmk_item_before_inner(__('Grid-1', 'lollum'));
