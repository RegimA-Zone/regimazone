 ...
 * Lollum
 * 
 * The Template for displaying Portoflio pages with 4 columns
 *
 * @package WordPress
 ...
 */
/*
Template Name: Portfolio Template (4 columns)
*/
?>
									...
									<div class="row">
										<div class="lm-col-12">
											<div class="section-portfolio-items <?php echo $section_filterable; ?>">
												...
												<div class="portfolio-item <?php echo $item_classes; ?> lm-col-3">
